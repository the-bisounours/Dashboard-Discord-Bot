...
module.exports = {
    ...
    execute: async (client, interaction) => {
        ...
        if (member.user.id === interaction.guild.ownerId) {
            return await interaction.reply({
                content: `${client.emo.no} Vous ne pouvez pas couper le casque du propriétaire du serveur discord.`,
                ephemeral: true
            });
        };
        ...
        if (member.user.id === interaction.user.id) {
            return await interaction.reply({
                content: `${client.emo.no} Pourquoi essayez-vous de vous couper votre casque ?`,
                ephemeral: true
            });
        };
        ...
        if (member.user.id === client.user.id) {
            return await interaction.reply({
                content: `${client.emo.no} Vous ne pouvez pas couper mon casque.`,
                ephemeral: true
            });
        };
        ...
        if (interaction.user.id !== interaction.guild.ownerId && interaction.member.roles.highest.comparePositionTo(member.roles.highest) <= 0) {
            return await interaction.reply({
                content: `${client.emo.no} Vous ne pouvez pas couper le casque d'un membre plus haut que vous.`,
                ephemeral: true
            });
        };
        ...
        if (interaction.guild.members.me.roles.highest.comparePositionTo(member.roles.highest) <= 0) {
            return await interaction.reply({
                content: `${client.emo.no} Je ne peux pas couper le casque d'un membre plus haut que moi.`,
                ephemeral: true
            });
        };
        ...
        if (!member.voice || !member.voice?.channel) {
            return await interaction.reply({
                content: `${client.emo.no} Le membre n'est pas en vocal.`,
                ephemeral: true
            });
        };
        ...
        if (member.voice.deaf) {
            return await interaction.reply({
                content: `${client.emo.no} Le membre a déjà le casque d'activé.`,
                ephemeral: true
            });
        };

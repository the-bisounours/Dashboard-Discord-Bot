...
module.exports = {
    ...
    execute: async (client, interaction) => {
        ...
        data.invites.joinMessage.unknown = defaultDb(Guilds.schema).invites.joinMessage.unknown
        await data.save();
        ...
        return await interaction.update({
            embeds: [
                new EmbedBuilder()
                    ...
                    .setColor("Blurple")
                    .setDescription(`Vous êtes en train de modifier les messages d'arrivés (\`unknown\`). Il est actuellement défini sur:\n\`\`\`\n${data.invites.joinMessage.unknown ? data.invites.joinMessage.unknown : "Aucun"}\n\`\`\`\n\n**Aperçu du message:** \n${replace(data.invites.joinMessage.unknown, {
                        member: client,
